// node_modules/.pnpm/@unhead+shared@1.9.16/node_modules/@unhead/shared/dist/index.mjs
...
// node_modules/.pnpm/@unhead+dom@1.9.16/node_modules/@unhead/dom/dist/index.mjs
...
// node_modules/.pnpm/unhead@1.9.16/node_modules/unhead/dist/index.mjs
...
function useScript(_input, _options) {
  ...
  const proxy = { instance: !head.ssr && ((_c = options == null ? void 0 : options.use) == null ? void 0 : _c.call(options)) || {} };
  ...
  const instance = new Proxy(proxy, {
    get({ instance: _ }, k2) {
      var _a2;
      const stub = (_a2 = options.stub) == null ? void 0 : _a2.call(options, { script: proxy.$script, fn: k2 });
      if (stub)
        return stub;
      if (k2 === "$script")
        return proxy.$script;
      const exists = _ && k2 in _ && typeof _[k2] !== "undefined";
      head.hooks.callHook("script:instance-fn", { script, fn: k2, exists });
...
//# sourceMappingURL=chunk-DCN6XTJ2.js.map
